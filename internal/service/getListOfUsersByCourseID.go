...
func (s *Service) GetListOfUsersByCourseID(courseID int) (applications []models.Application, err error) {
	...
	for i, v := range applications {
		...
		xlsx.SetCellValue("Sheet1", fmt.Sprintf("C%v", i+2), user.DateOfBirth)
